package com.kish.eshop.datasync.service;
...
import com.kish.eshop.datasync.fallback.EshopProductFallback;

@FeignClient(value = "product-service",fallback=EshopProductFallback.class)
